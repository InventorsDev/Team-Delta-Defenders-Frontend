...
const Footer = () => {
  return (
    <footer className="bg-[#0A2600] text-white py-16">
      {/* Top Section */}
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left border-b border-gray-700 pb-8 mb-8">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 mt-8 md:mt-0">
          <button className="bg-green-500 text-white font-bold py-3 px-6 rounded-xl hover:bg-green-600 transition-colors">
            Farmers Sign Up
          </button>
          <button className="bg-gray-200 text-gray-900 font-bold py-3 px-6 rounded-xl hover:bg-gray-300 transition-colors">
            Buyers Sign Up
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <form className="flex flex-col">
            <input
              ...
              className="p-3 rounded-lg border border-green-500 bg-gray-900 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
            />
            <button
              type="submit"
